...
function index() {
  return (
    <div style={{ paddingTop: "70px" }} className="main">
      <div className={styles.title}>
        <h1> ABOUT</h1>
      </div>
      <div className={styles.descCont}>
        <div className={styles.desc}>
          <h1>NGABO’ EL’CESART” DESIRE</h1>
          <p>
            {" "}
            Who El’Cesart ? Spirited, Skilled And Sincere Are Only A Few Words
            To Describe The Upcoming Artist. Ngabo D.Cesar Also Known As
            El’Cesart Is A 27 years old Visual
          </p>
          <p>
            Artist & Illustrator Creating Honest Work Celebrating Black People,
            Culture And Afro-Futurism. His Work Takes The Form Of Digital
            Illustration, Paint, Apparel Designing, And Photography. El’Cesart
            Explores Pop Society, Turning It Into An Intriguing Globe Of Bold
            Colours, Textures And Prints. Uplifted And Inspired By Black Culture
          ...
          <p>
            ...
            El’Cesart Is An Emerging Influencer Of The New Era Inspired To Push
            ...
            B.Jordan, Lupita Nyong’o, Anderson Paak, Jaden And Willow Smith, T-
          ...
          <p>
            ...
            Shedding Light On Communities Of Black Africans, El’Cesart Has
          ...
          <p>
            El’Cesart Has Taken A Bigger Steps By Starting To Collaborate With
            ...
            Amazing Artworks For Their Oscar Winning Movie''If Beale Street
            Could Talk'' A Movie Directed By The Oscar Winning Director Barry
            Jenkins. El'Cesart Also worked on other films like Lovecraft
            Country, Phat Tuesday Documentary, The U.S vs Billie Holiday, etc..{" "}
          </p>
          <p>
            {" "}
            ...
            Body And Face. Desire’s Bright And Detailed Interpretations Show His
            Persistent Pure Motives To Empower Black Culture And Help The
            Audience Connect With Their Experiences. He Addresses The
            Representation Of Black Beauty, Sexuality And Power In Today’s
            World. El’Cesart Is Defiantly Rare In Rendering Paint Against Canvas
            And Digital Illustration, But What Really Sets His Work Apart Is Its
        ...
        <div className={styles.image}>
          <img src="/images/headShot.webp" alt="head-shot" />
        </div>
      </div>
    </div>
  );
